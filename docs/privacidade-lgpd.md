...
Receita Federal: Simples (Listagem de Períodos para Emissão de DAS) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [receita_federal_listar_das@mcp.ai](mailto:receita_federal_listar_das@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
